...
> [!NOTE]
> Так как я использовал бесплатный тариф Render, при первом переходе по ссылке после долгого простоя может потребоваться **30-50 секунд** для «пробуждения» сервиса.
